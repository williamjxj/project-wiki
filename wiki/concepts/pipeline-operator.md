...
A shared **pipeline core** should own ingest/lint/export/sync; UIs and MCP are thin adapters — validated by both Claude's plan and the implemented experimental-app operator.

## Divergence

| Topic | Claude plan (this source) | Implemented (experimental-app) |
|-------|---------------------------|--------------------------------|
